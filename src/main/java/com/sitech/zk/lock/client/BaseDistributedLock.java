...
public class BaseDistributedLock {
    ...
    protected String attemptLock(long time, TimeUnit unit) throws Exception {
        ...
        while ( !isDone ) {
            ...
            try {
                //edit by yuanxm,不支持递归创建节点,创建的临时节点也不支持
                //client.delete(this.basePath);
                if( !client.exists(this.basePath) ){
                    //createLockNode(client,this.basePath);
                    client.createPersistent(this.basePath);
                }
